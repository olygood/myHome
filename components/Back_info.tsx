    ...
    return (
        <div className='flex w-full flex-row justify-between items-center p-2 bg-slate-950'>
            ...
            <div className='flex flex-row gap-3' >
                ...
                <svg viewBox="0 0 128 128" className="w-5 text-white mr-2">
                    <path 
                    ...
                    <p className='text-light text-white'>olihuttmacher</p>
                   
                </div>
                <div className='flex items-center'>
                    <svg viewBox="0 0 128 128" className='w-5 mr-2'>
                        <g fill="#ffffff">
                    ...
                    <p className='text-regular text-white'>olygood</p>

                </div>
                </div>
            </div>

            <div className='back_info_time flex flex-col text-lg'>
                <p className='text-light text-white'>5min read</p>
                <p className='text-thinItalic text-white text-sm'>8 hours ago</p>
            </div>
